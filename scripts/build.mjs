...
execFileSync(process.execPath, [tscPath], { cwd: packageRoot, stdio: "inherit" });

const distDir = join(packageRoot, "dist");
if (!existsSync(distDir)) mkdirSync(distDir, { recursive: true });
copyFileSync(join(packageRoot, "src", "anthropic-prompt.txt"), join(distDir, "anthropic-prompt.txt"));
